    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4 text-slate-200">
        <div className="space-y-1.5">
          <label className="block text-xs font-medium text-slate-300">Họ và Tên (*):</label>
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 bg-slate-900 border border-slate-700 rounded-xl text-xs text-white placeholder-slate-500 focus:ring-2 focus:ring-emerald-500 focus:outline-none"
            />
          </div>
        </div>

        <div className="space-y-1.5">
          <label className="block text-xs font-medium text-slate-300">Địa chỉ Email (*):</label>
          <div className="relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div className="space-y-1.5">
            <label className="block text-xs font-medium text-slate-300">Mật Khẩu Ban Đầu:</label>
            <div className="relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
          <div className="space-y-1.5">
            <label className="block text-xs font-medium text-slate-300">Gán Phân Quyền (Role):</label>
            <select
              value={role}
          ...
          <div className="space-y-1.5">
            <label className="block text-xs font-medium text-slate-300">Trạng Thái Ban Đầu:</label>
            <select
              value={status}
